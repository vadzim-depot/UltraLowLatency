...
./cmake-build-debug/trading_main  1 MAKER \
                                  100 0.6 150 300 -100 \
                                  60 0.6 150 300 -100 \
                                  150 0.5 250 600 -100 \
...
#./cmake-build-debug/trading_main  2 MAKER \
...
#sleep 5
#
#./cmake-build-debug/trading_main  3 TAKER \
#                                  300 0.8 350 300 -300 \
#                                  60 0.7 350 300 -300 \
#                                  350 0.5 250 600 -300 \
...
#sleep 5
#
#./cmake-build-debug/trading_main  4 TAKER \
...
./cmake-build-debug/trading_main  5 RANDOM &
sleep 5
